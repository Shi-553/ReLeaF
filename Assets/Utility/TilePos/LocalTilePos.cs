...
namespace Utility
{
    ...
    public class LocalTilePos
    {
        ...
        [SerializeField, Rename("上を向いたときのローカルポジション"), EditTilePos]
        ArrayWrapper<Vector2Int> upList;
        [SerializeField, Rename("下を向いたときのローカルポジション"), EditTilePos]
        ArrayWrapper<Vector2Int> downList;
        [SerializeField, Rename("左を向いたときのローカルポジション"), EditTilePos]
        ArrayWrapper<Vector2Int> leftList;
        [SerializeField, Rename("右を向いたときのローカルポジション"), EditTilePos]
